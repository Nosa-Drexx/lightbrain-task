...
const FeaturedContents = () => {
  return (
    <section className="flex gap-12 w-full overflow-auto hide-scrollbar py-3">
      {featuredList.map((content, index) => {
        return <FeaturedListingCard key={index} content={content} />;
      })}
      <div className="flex flex-col justify-end shadow-lg w-[300px] h-[350px] min-w-[300px] p-6 gap-5 bg-no-repeat last-card-featured relative">
